...
export function RoomCreatedScreen({ roomCode, slot1Name, slot2Name, slot2Filled, waitingMessage }: RoomCreatedScreenProps) {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[var(--bg)] text-[var(--text)]">
      ...
      <div className="relative z-10 anim-slide-up w-full max-w-[460px] flex flex-col gap-5 px-4 sm:px-6 py-8 mx-auto">
        ...
        <div
          className="bg-white dark:bg-[#0f0f0f] border border-[var(--border)] rounded-2xl flex flex-col gap-6 p-6 sm:p-8"
